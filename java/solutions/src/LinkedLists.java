...
public class LinkedLists {
    ListNode mergeTwoLists(ListNode list1, ListNode list2) {
        ...
        return ans.next; // as temp was pointing to ans first then followed by rest of two lists, we can return ans.next which will give the start position(head) of the temp.
    }
}
